    ...
    */
    refreshPlaylist(playlist) {
        ...
        for (let i = 0; i < playlist.songs.length; i++) {
            ...
            let songIndex = document.createTextNode((i + 1) + ". ")
            itemDiv.appendChild(songIndex);
            let itemText = `<a href="https://www.youtube.com/embed/${song.youTubeId}">${song.title + " by " + song.artist}</a>`;
            itemDiv.insertAdjacentHTML("beforeend", itemText);
